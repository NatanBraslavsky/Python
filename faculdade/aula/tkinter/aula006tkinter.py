...
t = Label(i,text='Qual o seu esporte favorito',bg='#CECECE')
a1 = Checkbutton(i,text='Futebol',bg='#CECECE',variable=futebol_var)
a2 = Checkbutton(i,text='Volei',bg='#CECECE',variable=volei_var)
a3 = Checkbutton(i,text='Natação',bg='#CECECE',variable=natacao_var)
a4 = Checkbutton(i,text='Tenis',bg='#CECECE',variable=tenis_var)
a5 = Checkbutton(i,text='Basquete',bg='#CECECE',variable=basquete_var)
a6 = Checkbutton(i,text='Surf',bg='#CECECE',variable=surf_var)
...
r_label = Label(i,text='Esportes selecionados: Nenhum',bg='#CECECE')
...
r1 = Radiobutton(i,text='Opção 1',variable=valor,value=1,bg='#CECECE')
r2 = Radiobutton(i,text='Opção 2',variable=valor,value=2,bg='#CECECE')
r3 = Radiobutton(i,text='Opção 3',variable=valor,value=3,bg='#CECECE')
